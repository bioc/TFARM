...
heatI <- function(TFs,I){
  ...
  #windows()
  #image.plot(seq(0,1, length=l), seq(0,1, length=l),matrix_imp,col=heat.colors(20), axes=FALSE,ylim=c(1.04,-0.04))
  ...
  image.plot(matrix_imp,col=heat.colors(20),legend.only=T,ylim=c(1.04,-0.04))
